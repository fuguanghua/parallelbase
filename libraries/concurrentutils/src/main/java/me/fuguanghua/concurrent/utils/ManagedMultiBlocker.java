...
/**
 * A {@link ForkJoinPool.ManagedBlocker} that bundles multiple other
 * {@link ForkJoinPool.ManagedBlocker} into a single blocker; this may reduce the overhead relative
...
public class ManagedMultiBlocker implements ForkJoinPool.ManagedBlocker {
  ...
  /**
   * Convenience method that blocks on multiple {@link ForkJoinPool.ManagedBlocker}s
